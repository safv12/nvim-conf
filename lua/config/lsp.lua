...
local on_attach = function(client, bufnr)
  ...
  vim.api.nvim_buf_set_keymap(bufnr, "n", "gr", ":lua require('telescope.builtin').lsp_references()<cr>", {noremap = true})
  vim.api.nvim_buf_set_keymap(bufnr, "n", "sd", ":lua require('telescope.builtin').diagnostics()<cr>", {noremap = true})
